...
public class AddIncomeSecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_income_second);
                    ...
                    iconReference.child(iconAdapter.getRef(position).getKey()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists())
                            {
                                ...
                                Toast toast = Toast.makeText(AddIncomeSecond.this, "New income added: "+name, Toast.LENGTH_LONG);
...
//                                toastView.setBackgroundColor(Color.DKGRAY);
                                toast.show();
                                Intent i=new Intent(getApplicationContext(),NewIncome.class);
                                startActivity(i);
                            }
                        }
