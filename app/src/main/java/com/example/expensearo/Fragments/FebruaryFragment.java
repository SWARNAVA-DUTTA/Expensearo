...
public class FebruaryFragment extends Fragment {
    private View februaryExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        februaryExpenseView=inflater.inflate(R.layout.fragment_february, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=februaryExpenseView.findViewById(R.id.income);
        cell_content_view=februaryExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new FebruaryFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), februaryExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=februaryExpenseView.findViewById(R.id.totalIncome);
        totalExpense=februaryExpenseView.findViewById(R.id.totalExpense);
        balance_left=februaryExpenseView.findViewById(R.id.balance_left);
        expense_list=februaryExpenseView.findViewById(R.id.expense_list);
        monthly_budget=februaryExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) februaryExpenseView.findViewById(R.id.folding_cell);
        month_name=februaryExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("February");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("February").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","February");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new FebruaryFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    FebruaryFragment.onSwipeListener onSwipe;
}