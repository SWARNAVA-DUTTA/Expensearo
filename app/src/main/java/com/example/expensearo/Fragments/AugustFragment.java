...
public class AugustFragment extends Fragment {
    private View augustExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        augustExpenseView=inflater.inflate(R.layout.fragment_august, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=augustExpenseView.findViewById(R.id.income);
        cell_content_view=augustExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new AugustFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), augustExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=augustExpenseView.findViewById(R.id.totalIncome);
        totalExpense=augustExpenseView.findViewById(R.id.totalExpense);
        balance_left=augustExpenseView.findViewById(R.id.balance_left);
        expense_list=augustExpenseView.findViewById(R.id.expense_list);
        monthly_budget=augustExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) augustExpenseView.findViewById(R.id.folding_cell);
        month_name=augustExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("August");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("August").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","August");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new AugustFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    AugustFragment.onSwipeListener onSwipe;
}