...
public class DecemberFragment extends Fragment {
    private View decemberExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        decemberExpenseView=inflater.inflate(R.layout.fragment_december, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=decemberExpenseView.findViewById(R.id.income);
        cell_content_view=decemberExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new DecemberFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), decemberExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=decemberExpenseView.findViewById(R.id.totalIncome);
        totalExpense=decemberExpenseView.findViewById(R.id.totalExpense);
        balance_left=decemberExpenseView.findViewById(R.id.balance_left);
        expense_list=decemberExpenseView.findViewById(R.id.expense_list);
        monthly_budget=decemberExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) decemberExpenseView.findViewById(R.id.folding_cell);
        month_name=decemberExpenseView.findViewById(R.id.month_name);
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("December");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("December").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","December");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new DecemberFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    DecemberFragment.onSwipeListener onSwipe;
}