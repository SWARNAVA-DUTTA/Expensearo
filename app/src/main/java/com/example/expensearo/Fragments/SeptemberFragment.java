...
public class SeptemberFragment extends Fragment {
    private View septemberExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        septemberExpenseView=inflater.inflate(R.layout.fragment_september, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=septemberExpenseView.findViewById(R.id.income);
        cell_content_view=septemberExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new SeptemberFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), septemberExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=septemberExpenseView.findViewById(R.id.totalIncome);
        totalExpense=septemberExpenseView.findViewById(R.id.totalExpense);
        balance_left=septemberExpenseView.findViewById(R.id.balance_left);
        expense_list=septemberExpenseView.findViewById(R.id.expense_list);
        monthly_budget=septemberExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) septemberExpenseView.findViewById(R.id.folding_cell);
        month_name=septemberExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("September");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("September").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        expenseAdapter.setOnItemClickListener(new ExpenseAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                i.putExtra("monthName","September");
                startActivity(i);
            }
        });
        ...
        monthlyBudgetAdapter.setOnItemClickListener(new MonthlyBudgetAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                monthlyBudgetRef.child("All Transactions").child(monthlyBudgetAdapter.getRef(position).getKey()).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","September");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new SeptemberFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    SeptemberFragment.onSwipeListener onSwipe;
}