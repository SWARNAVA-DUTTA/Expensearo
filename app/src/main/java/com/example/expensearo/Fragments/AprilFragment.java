...
public class AprilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aprilExpenseView=inflater.inflate(R.layout.fragment_april, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=aprilExpenseView.findViewById(R.id.income);
        cell_content_view=aprilExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new AprilFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), aprilExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=aprilExpenseView.findViewById(R.id.totalIncome);
        totalExpense=aprilExpenseView.findViewById(R.id.totalExpense);
        balance_left=aprilExpenseView.findViewById(R.id.balance_left);
        expense_list=aprilExpenseView.findViewById(R.id.expense_list);
        monthly_budget=aprilExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) aprilExpenseView.findViewById(R.id.folding_cell);
        month_name=aprilExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("April");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("April").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","April");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new AprilFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    AprilFragment.onSwipeListener onSwipe;
}