...
public class MayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mayExpenseView=inflater.inflate(R.layout.fragment_may, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=mayExpenseView.findViewById(R.id.income);
        cell_content_view=mayExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new MayFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), mayExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=mayExpenseView.findViewById(R.id.totalIncome);
        totalExpense=mayExpenseView.findViewById(R.id.totalExpense);
        balance_left=mayExpenseView.findViewById(R.id.balance_left);
        expense_list=mayExpenseView.findViewById(R.id.expense_list);
        monthly_budget=mayExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) mayExpenseView.findViewById(R.id.folding_cell);
        month_name=mayExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("May");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("May").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new MayFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    MayFragment.onSwipeListener onSwipe;
}