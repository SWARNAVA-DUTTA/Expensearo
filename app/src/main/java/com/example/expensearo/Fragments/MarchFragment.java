...
public class MarchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        marchExpenseView=inflater.inflate(R.layout.fragment_march, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=marchExpenseView.findViewById(R.id.income);
        cell_content_view=marchExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new MarchFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), marchExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=marchExpenseView.findViewById(R.id.totalIncome);
        totalExpense=marchExpenseView.findViewById(R.id.totalExpense);
        balance_left=marchExpenseView.findViewById(R.id.balance_left);
        expense_list=marchExpenseView.findViewById(R.id.expense_list);
        monthly_budget=marchExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) marchExpenseView.findViewById(R.id.folding_cell);
        month_name=marchExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("March");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("March").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","March");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new MarchFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    MarchFragment.onSwipeListener onSwipe;
}