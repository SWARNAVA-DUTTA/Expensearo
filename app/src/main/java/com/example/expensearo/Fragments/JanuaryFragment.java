...
public class JanuaryFragment extends Fragment {
    private View januaryExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        januaryExpenseView=inflater.inflate(R.layout.fragment_january, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=januaryExpenseView.findViewById(R.id.income);
        cell_content_view=januaryExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new JanuaryFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), januaryExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=januaryExpenseView.findViewById(R.id.totalIncome);
        totalExpense=januaryExpenseView.findViewById(R.id.totalExpense);
        balance_left=januaryExpenseView.findViewById(R.id.balance_left);
        expense_list=januaryExpenseView.findViewById(R.id.expense_list);
        monthly_budget=januaryExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) januaryExpenseView.findViewById(R.id.folding_cell);
        month_name=januaryExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("January");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("January").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","January");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new JanuaryFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    JanuaryFragment.onSwipeListener onSwipe;
}