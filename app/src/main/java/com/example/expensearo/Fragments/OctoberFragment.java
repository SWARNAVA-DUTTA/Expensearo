...
public class OctoberFragment extends Fragment {
    private View octoberExpenseView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        octoberExpenseView=inflater.inflate(R.layout.fragment_october, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=octoberExpenseView.findViewById(R.id.income);
        cell_content_view=octoberExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new OctoberFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), octoberExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=octoberExpenseView.findViewById(R.id.totalIncome);
        totalExpense=octoberExpenseView.findViewById(R.id.totalExpense);
        balance_left=octoberExpenseView.findViewById(R.id.balance_left);
        expense_list=octoberExpenseView.findViewById(R.id.expense_list);
        monthly_budget=octoberExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) octoberExpenseView.findViewById(R.id.folding_cell);
        month_name=octoberExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("October");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("October").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","October");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new OctoberFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    OctoberFragment.onSwipeListener onSwipe;
}