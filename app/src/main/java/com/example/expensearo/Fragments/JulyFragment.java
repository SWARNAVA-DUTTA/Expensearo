...
public class JulyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        julyExpenseView=inflater.inflate(R.layout.fragment_july, container, false);
        mAuth=FirebaseAuth.getInstance();
        income=julyExpenseView.findViewById(R.id.income);
        cell_content_view=julyExpenseView.findViewById(R.id.cell_content_view);
        onSwipeTouchListener = new JulyFragment.OnSwipeTouchListener(getActivity().getApplicationContext(), julyExpenseView.findViewById(R.id.view));
        String currentUserId=mAuth.getCurrentUser().getUid();
        totalIncome=julyExpenseView.findViewById(R.id.totalIncome);
        totalExpense=julyExpenseView.findViewById(R.id.totalExpense);
        balance_left=julyExpenseView.findViewById(R.id.balance_left);
        expense_list=julyExpenseView.findViewById(R.id.expense_list);
        monthly_budget=julyExpenseView.findViewById(R.id.monthly_budget);
        fc = (FoldingCell) julyExpenseView.findViewById(R.id.folding_cell);
        month_name=julyExpenseView.findViewById(R.id.month_name);
       ...
       LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity().getApplicationContext());
        ...
        monthlyBudgetRef=FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("July");
        FirebaseRecyclerOptions<MonthlyBudget> budget =
                new FirebaseRecyclerOptions.Builder<MonthlyBudget>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserId).child(String.valueOf(year)).child("July").child("All Transactions").orderByChild("date"), MonthlyBudget.class)
                        .build();
        ...
        income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                income.putExtra("monthName","July");
    ...
    public class OnSwipeTouchListener implements View.OnTouchListener {
        ...
        OnSwipeTouchListener(Context ctx, View mainView) {
            gestureDetector = new GestureDetector(ctx, new JulyFragment.OnSwipeTouchListener.GestureListener());
...
//            this.onSwipe.swipeLeft();
    ...
    JulyFragment.onSwipeListener onSwipe;
}