        ...
        iconAdapter.setOnItemClickListener(new IconAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                if (name.equals(""))
                    ...
                    iconReference.child(iconAdapter.getRef(position).getKey()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists())
                            {
                                ...
                                map.put("Name", name);
                                map.put("Icon", icon);
                                FirebaseDatabase.getInstance().getReference().child("Users").child(mAuth.getCurrentUser().getUid()).child("Categories").child("Expense").push().setValue(map);
                            }
                        }
                    ...
                    Toast toast = Toast.makeText(AddExpense.this, "New expense added: "+name, Toast.LENGTH_LONG);
...
//                    toastView.setBackgroundColor(Color.DKGRAY);
    ...
    private void setupToolbar() {
        toolbar = (Toolbar) findViewById(R.id.toolbar_add_expense);
